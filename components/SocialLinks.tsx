...
type SocialKey = "whatsapp" | "instagram" | "facebook" | "tiktok";
...
const iconClass =
  "flex h-11 w-11 items-center justify-center rounded-full border border-gold-400/30 bg-surface-elevated text-gold-400 transition hover:bg-gold-400/10 hover:text-gold-300";
...
export function SocialLinks({
  ...
  ].filter((link) => Boolean(link.href) && !exclude.includes(link.key));
